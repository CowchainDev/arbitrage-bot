  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-card border border-border rounded-lg overflow-hidden">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 px-4 py-2.5 border-t border-border/40 text-xs text-muted-foreground">
          <span className="font-medium text-muted-foreground/70 mr-1">Realized PnL source:</span>
          <span className="inline-flex items-center gap-1">
            <CheckCircle2 className="w-3 h-3 text-emerald-500 shrink-0" />
            Exchange-reported (authoritative)
          </span>
          <span className="inline-flex items-center gap-1">
            <span className="font-normal">~</span>
            Estimated locally from entry/exit spread and fees
          </span>
          <span className="inline-flex items-center gap-1">
            <span className="w-3 h-3 shrink-0" />
            No indicator — exchange-reported or pre-dates this feature
          </span>
        </div>
      </div>
    </div>

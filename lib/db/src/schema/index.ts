...
export const closedTradesTable = pgTable(
  "closed_trades",
  {
    ...
    longEntryPrice: numeric("long_entry_price", { precision: 20, scale: 8 }),
    shortEntryPrice: numeric("short_entry_price", { precision: 20, scale: 8 }),
    longExitPrice: numeric("long_exit_price", { precision: 20, scale: 8 }),
    shortExitPrice: numeric("short_exit_price", { precision: 20, scale: 8 }),
...
export const botLegsTable = pgTable(
  "bot_legs",
  {
    ...
    legExchangeA: text("leg_exchange_a"),
    legExchangeB: text("leg_exchange_b"),
